            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="pb-3">
                        ...
                        <div class="bg-white mb-3" style="padding: 30px;">
                            ...
                            <img class="img-fluid w-50 float-left mr-4 mb-2" src="{{asset('frontend/img/blog-2.jpg')}}">
                            ...
                            <img class="img-fluid w-50 float-right ml-4 mb-2" src="{{asset('frontend/img/blog-3.jpg')}}">
                            <p>Diam dolor est labore duo invidunt ipsum clita et, sed et lorem voluptua tempor
                                invidunt at est sanctus sanctus. Clita dolores sit kasd diam takimata justo diam
                                lorem sed. Magna amet sed rebum eos. Clita no magna no dolor erat diam tempor
                                rebum consetetur, sanctus labore sed nonumy diam lorem amet eirmod. No at tempor
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    ...
                    <div class="d-flex flex-column text-center bg-white mb-5 py-5 px-4">
                        <img src="{{asset('frontend/img/user.jpg')}}" class="img-fluid mx-auto mb-3" style="width: 100px;">
                    ...
                    <div class="mb-5">
                        ...
                        <a class="d-flex align-items-center text-decoration-none bg-white mb-3" href="">
                            <img class="img-fluid" src="{{asset('frontend/img/blog-100x100.jpg')}}" alt="">
                            <div class="pl-3">
